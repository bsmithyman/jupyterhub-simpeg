...
RUN apt-get -y install cython python-numpy python-scipy python-matplotlib python-mpi4py python-tables python-openssl python-pyasn1 python-pyasn1-modules python-nose python-h5py python-sphinx pylint pydot
