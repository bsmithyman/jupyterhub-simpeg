...
RUN apt-get -y install cython python-numpy python-scipy python-matplotlib python-mpi4py python-h5py python-tables python-openssl python-pyasn1 python-pyasn1-modules
RUN apt-get -y install cython3 python3-numpy python3-scipy python3-matplotlib python3-mpi4py python-h5py python3-tables python3-openssl python3-pyasn1
